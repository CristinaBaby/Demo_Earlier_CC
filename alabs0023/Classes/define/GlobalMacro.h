...
// ------------------------------------------------------------------
#define project_name                            "Doodle Coloring Book for Adult"

#if (CC_TARGET_PLATFORM == CC_PLATFORM_IOS) // iOS

#define apple_id                                "1121541438"

#define st_flurry_key                           "BYM6GZ393XY89DV7FGYP"
...
/*  android os */
#define st_android_package_name                 "net.applabsinc.android_doodlecoloringbook"
...
// Google Play version
#define st_flurry_key                           "7XCP9TC69H8KQXDKNX6P"
...
#define st_load_csv_fail_notification "load_csv_fail_notification"
#define st_check_is_download_notification "check_is_download_notification"
#define st_download_finish_notification "download_finish_notification"
#define st_texture_load_finish_notification "texture_load_finish_notification"
#define st_no_new_version_readcsv_finish_notification "no_new_version_readcsv_finish_notification"
#define st_begin_download_image "st_begin_download_image"
...
#define st_screen_center_position Vec2(384,512)
...
#define st_rateUs_count     "st_rateUs_count"
