...
bool  DataManager::m_bIspainted = false;
...
Color3B DataManager::getSaveBackColor(int pIndex)
{
    ...
    color.r = UserDefault::getInstance()->getIntegerForKey(ss.str().c_str(), 255);
    ...
    ss2<<pIndex;
    ss2<<"_G";
    color.g = UserDefault::getInstance()->getIntegerForKey(ss2.str().c_str(), 255);
    ...
    color.b = UserDefault::getInstance()->getIntegerForKey(ss3.str().c_str(), 255);
