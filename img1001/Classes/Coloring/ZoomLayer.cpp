...
#define RATIO 1.0f
            ...
            if(lTouch->getLocation().y<ScreenAdapterHelper::getValue(270) ||  lTouch->getLocation().y>ScreenAdapterHelper::getRealDesignSize().height-ScreenAdapterHelper::getValue(120))
            {
                return;
            }
