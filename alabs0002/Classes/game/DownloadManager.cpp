...
#define st_csv_file_chapter     "chapter.csv"
#define st_csv_file_pallette    "http://liveupdate.toyboxapps.com/coloring/ALABS0002/color/"
#define st_csv_file_xxx         "language.csv"

#define st_csv_file_name        "graph.csv"
#define st_version_file_name    "version_2.php"

#define st_versionCsvUrl "http://liveupdate.toyboxapps.com/coloring/ALABS0002/color/graph.csv"
#define st_versionUrl "http://liveupdate.toyboxapps.com/coloring/ALABS0002/color/version_2.php"
#define st_download_dir "http://liveupdate.toyboxapps.com/coloring/ALABS0002/color"
        ...
        case FIND_NEW_VERSION_STATE:
        {
            ...
            if (!_hinted) {
                if (Director::getInstance()->getRunningScene()->getName() == "ChapterScene") {
                    _hinted = true;
                    xDialog->show("find_new", "cancel", "ok", CC_CALLBACK_1(DownloadManager::onDialog, this));
                }
            }
        }
            break;
