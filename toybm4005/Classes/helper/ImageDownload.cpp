...
#define st_csv_file_name "color.csv"
#define st_csv_file_name_spare "color_spare.csv"
#define st_version_file_name "version.php"


#define st_versionCsvUrl "http://liveupdate.toyboxapps.com/coloring/TOYBM4005/color/color.csv"
#define st_versionUrl "http://liveupdate.toyboxapps.com/coloring/TOYBM4005/color/version.php"
#define st_download_dir "http://liveupdate.toyboxapps.com/coloring/TOYBM4005/color"
...
void ImageDownload::readCsvData()
{
    ...
    for (int r=1; r<row; r++) {
        ...
        lInfo.image_name_w=lCsv->getDatas(r, "name_white");
