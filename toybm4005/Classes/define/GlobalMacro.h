...
// ------------------------------------------------------------------
#define project_name                            "Kids Coloring Book"

#if (CC_TARGET_PLATFORM == CC_PLATFORM_IOS) // iOS

#define apple_id                                "1027240756"

#define st_flurry_key                           "QYFQKMKYCCSQM4Q8FQQN"
...
/*  android os */
#define st_android_package_name                 "com.toyboxmediainc.android_kidscoloringbookpremium"
...
// Google Play version
#define st_flurry_key                           "DBFXV2D94SDXVSZSDRR3"
