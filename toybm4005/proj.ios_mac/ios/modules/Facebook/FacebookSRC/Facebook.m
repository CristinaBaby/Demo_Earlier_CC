...
- (NSString *)getOwnBaseUrl {
  ...
  // EDIT:
  // this is suggest by Facebook documentation, check it out here:
  // http://developers.facebook.com/docs/authentication/ section: Desktop Apps
  //return @"https://www.facebook.com/connect/login_success.html";
  // as I test, Facebook server only accepts https://www.facebook.com/connect/login_success.html and fbconnect://success as
  // redirect_uri, since application delegate doesn't handle the https one, we use fbconnet here
...
- (void)authorize:(NSArray *)permissions {
  ...
  // EDIT:
  // force using UIWebView Facebookk Dialog to auth
...
- (void)logout:(id<FBSessionDelegate>)delegate {
  ...
  // EDIT:
  // in fact the above code can't delete the cookies stored by UIWebView
  // use the code as below
  NSHTTPCookieStorage* cookieStore = [NSHTTPCookieStorage sharedHTTPCookieStorage];
  NSArray* facebookCookies = [cookieStore cookies];
...
- (void)fbDialogNotLogin:(BOOL)cancelled {
    if (_loginDialog) {
        [_loginDialog dismissWithError:NULL animated:YES];
    }
