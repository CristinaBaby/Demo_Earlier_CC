...
#include "../../Classes/hidd/modules/STAdsDelegate.h"
...
public:
	AndroidAdManager() :
			...
			MethodPreloadCrosspromo(0),MethodPreloadAllInterstitiall(0),MethodShowInterstitial(0),MethodShowCrosspromo(0),MethodSetAdsVisibility(0)
	{
	}
	~AndroidAdManager();
