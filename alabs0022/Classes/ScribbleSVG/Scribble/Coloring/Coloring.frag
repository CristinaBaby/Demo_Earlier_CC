...
uniform int i_coloring_black_target;//need draw the black area?
...
void main(){
    if((i_coloring_black_target == 0) && vec3equal(v_touched_color.rgb, kBlackColor.rgb)){//ignore the fragement in black line frame
        discard;//
    }
