...
// ------------------------------------------------------------------
#define project_name                            "Free Coloring Pages for Adults"

#if (CC_TARGET_PLATFORM == CC_PLATFORM_IOS) // iOS

#define apple_id                                "1095551699"

#define st_flurry_key                           "ZCFPC92YS27ZBJJNHBDT"
...
/*  android os */
#define st_android_package_name                 "net.applabsinc.android_freecoloringpagesforadults"
...
// Google Play version
#define st_flurry_key                           "86K2QN3K3QVG94QHNR3Z"
