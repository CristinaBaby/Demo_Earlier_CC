...
#define kNotifyAdLoadingLayerDone "kNotifyAdLoadingLayerDone"

class AdLoadingLayerBase: public CCLayer, public STAdsDelegate
{
public:
    ...
    void setLoadingDoneCallback(CCObject * target, SEL_CallFunc callback);
...
protected:
    ...
    bool _bLoadingCanRemove;
    
    bool _isRequestingLoadAd;
