...
bool GameFinishLayer::initGameComplete()
{
    ...
    do
    {
        ...
        CC_BREAK_IF(! title);
        title->setPosition(ccp_fixed_X(bg_center.x, 1070));
...
bool GameFinishLayer::initGameOver()
{
    ...
    do
    {
        ...
        CC_BREAK_IF(! title);
        title->setPosition(ccp_fixed_X((bg_center.x-get_offset(4)), 1055));
        pBatchNode->addChild(title);
...
bool GameFinishLayer::initAllLevelFinish()
{
    ...
    do
    {
        ...
        CCSprite* title = CCSprite::createWithSpriteFrameName("ui05_game_complete.png");
        CC_BREAK_IF(! title);
        title->setPosition(ccp_fixed_X(bg_center.x, 1090));
        pBatchNode->addChild(title);
