...
bool GameUILayer::initWithColor(const ccColor4B& color, GLfloat width, GLfloat height)
{
    ...
    do
    {
        ...
        CC_BREAK_IF(!pPause);
        pPause->setPosition(ccp2(137, 106));
        ...
        m_pBtnHint->setPosition(ccp2(1928, 116));
        ...
        m_pHintQuantityBg->setPosition(ccp2(1928, 150));
        ...
        m_pGameTime->setPosition(ccp_fixed_X(m_pUIBg->getContentSize().width/2, 220));
